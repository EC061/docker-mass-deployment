...
def add_container(container_name, username, password, port, image_name, 
                 cpu_limit, ram_limit, storage_limit, container_id=None, 
                 status="created", ip_address=None):
    ...
    try:
        ...
        ''', (
            container_name, username, password, port, image_name,
            cpu_limit, ram_limit, storage_limit, datetime.datetime.now(),
            status, container_id, ip_address
        ))
        conn.commit()
        return True
